...
const LTProductsCarousel4Mobile = () => {
      ...
      <div className="LTProductsCarousel4Mobile__container">
        ...
        <div className="LTProductsCarousel4MobileNav">
          <div className="LTProductsCarousel4MobileNav__arrow LTProductsCarousel4MobileNav__arrow--left">
            <button
              className="LTProductsCarousel4MobileArrow"
              onClick={handlePrev}
              aria-label="Anterior"
              type="button"
              disabled={animating}
          ...
          <div className="LTProductsCarousel4MobileNav__center">
            <div
              className="LTProductsCarousel4Mobile__slideTrack"
              onTouchStart={handleTouchStart}
              onTouchMove={handleTouchMove}
              onTouchEnd={handleTouchEnd}
            >
              <div
                className={`LTProductsCarousel4Mobile__card${
              ...
              >
                {/* Card content actual */}
                <div className="LTProductsCarousel4Mobile__discount">
                  -{products[currentIdx].discount}%
                </div>
                <div className="LTProductsCarousel4Mobile__image">
                  {products[currentIdx].image ? (
                    ...
                    <svg
                      viewBox="0 0 24 24"
                      className="LTProductsCarousel4Mobile__placeholderIcon"
                      style={{
                        width: "80px",
                        height: "80px",
                        margin: "0 auto",
                ...
                <div className="LTProductsCarousel4Mobile__info">
                  <div className="LTProductsCarousel4Mobile__brand">
                    {products[currentIdx].brand}
                  </div>
                  <div
                    className="LTProductsCarousel4Mobile__titleCard"
                    style={{
                      whiteSpace: "nowrap",
                      overflow: "hidden",
                  ...
                  <div className="LTProductsCarousel4Mobile__priceOld">
                    {formatPrice(products[currentIdx].originalPrice)}
                  </div>
                  <div className="LTProductsCarousel4Mobile__priceNew">
                    {formatPrice(products[currentIdx].discountPrice)}
                  </div>
                </div>
                <div className="LTProductsCarousel4Mobile__actions">
                  <button className="LTProductsCarousel4Mobile__addBtn">
                    <img
                      src={ShoppingBagIcon}
                      alt="Agregar"
                      className="LTProductsCarousel4Mobile__actionIcon"
                      style={{
                        width: "20px",
                        height: "20px",
                        marginRight: "6px",
              ...
              {animating && nextIdx !== null && (
                <div
                  className={`LTProductsCarousel4Mobile__card slide-in-${direction}`}
                  style={{
                    position: "absolute",
                    top: 0,
                    left: 0,
            ...
            <div className="LTProductsCarousel4Mobile__indicators">
              {products.map((_, idx) => (
                <div
                  key={idx}
                  className={`LTProductsCarousel4Mobile__indicator${
                    idx === currentIdx
                      ? " LTProductsCarousel4Mobile__indicator--active"
                      : ""
                  }`}
                />
              ))}
          ...
          <div className="LTProductsCarousel4MobileNav__arrow LTProductsCarousel4MobileNav__arrow--right">
            <button
              className="LTProductsCarousel4MobileArrow"
              onClick={handleNext}
...
export default LTProductsCarousel4Mobile;
