    ...
    <section className="LTProductsCarouselMobile__wrapper">
      <div className="LTProductsCarouselMobile__container">
        ...
        <div className="LTProductsCarouselMobileNav">
          <div
            className="LTProductsCarouselMobileNav__arrow LTProductsCarouselMobileNav__arrow--left"
          ...
          <div
            className="LTProductsCarouselMobileNav__arrow LTProductsCarouselMobileNav__arrow--right"
            style={{ padding: 0, margin: 0, boxSizing: "border-box" }}
          >
            <button
              className="LTProductsCarouselMobileArrow"
