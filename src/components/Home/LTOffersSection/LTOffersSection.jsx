// Componente de sección de ofertas. Cuando el backend esté, podés mapear los íconos y textos desde la base de datos si querés personalizar las ofertas.
...
const CirclePercentSvg = (
  <svg
    className="LTOffersSectionIconSvg"
    width="32"
    height="32"
    viewBox="0 0 24 24"
    fill="none"
...
const LTOffersSection = () => {
  // Array de ofertas. Si el backend quiere personalizar los ítems, mapear desde la base de datos y reemplazar este array.
  const offers = [
    {
      id: 1,
          ...
          {offers.map((offer, idx) => (
            <div key={idx} className="LTOffersSectionItem">
              ...
              <div className="LTOffersSectionLabel">
                ...
                {/* Si hay subtítulo, mostrarlo. El backend puede agregar más info si lo desea. */}
                {offer.sub && (
