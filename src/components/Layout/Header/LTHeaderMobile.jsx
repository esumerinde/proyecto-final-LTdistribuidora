...
const LTHeaderMobile = ({
  ...
  const effectiveShowOfferBar = showOfferBar || isAdmin || forcePinnedOffer;
  const effectiveForcePinned =
    ...
    <>
      ...
      >
        ...
        <nav className="LTHeaderMobile__menu">
          {!isUserLogged ? (
            /* Usuario no logueado: mostrar solo botón Ingresá */
            <button
              className="LTHeaderMobile__menuBtn LTHeaderMobile__loginBtn"
              onClick={openLogin}
              aria-label="Ingresá"
            >
              ...
              <span className="LTHeaderMobile__menuBtnText">Ingresá</span>
            </button>
          ) : (
            /* Usuario logueado: mostrar cuenta, favoritos, notificaciones y carrito */
            <>
