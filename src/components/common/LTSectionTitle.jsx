...
export default function LTSectionTitle({
  ...
  const hasAnimatedRef = useRef(false); // Para ejecutar solo una vez
    ...
    const io = new IntersectionObserver(
      (entries) => {
        ...
        if (entry.isIntersecting && !hasAnimatedRef.current) {
          ...
          setPlayed(true);
          hasAnimatedRef.current = true; // Marcar como ya animado
        }
        // No hacer nada si sale del viewport - mantener el estado
      },
      { threshold }
    );
